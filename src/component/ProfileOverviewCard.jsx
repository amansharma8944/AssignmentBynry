        ...
        <div className="flex flex-wrap justify-center">
            <div className="flex justify-center w-full">
                <div className="relative">
                    <img src="https://res.cloudinary.com/incquet-solution/image/upload/v1682686493/incquet/Products/Widgets/IQ%20Assistant/assets/standing-yellow-blue_rp4aet.png" className="dark:shadow-xl border-grey dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px] w-[140px] h-[143px] -top-[23px] rounded-full object-cover absolute" />
                </div>
            </div>
        </div>
